...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/green-mud-f5f0
```

A live public deployment of this template is available at [https://green-mud-f5f0.templates.workers.dev](https://green-mud-f5f0.templates.workers.dev)
